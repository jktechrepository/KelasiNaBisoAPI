...
namespace KelasiNaBiso.Models
{
    ...
    /// Format: "Categorie.Action" (ex: "Ecole.Create", "Paiement.Delete")
    /// </summary>
    public class Permission
    {
        ...
        /// <summary>
        /// Nom unique de la permission (ex: "Ecole.Create", "Paiement.Validate")
        /// </summary>
        [Required]
        [MaxLength(100)]
        ...
        /// <summary>
        /// Catégorie/Ressource concernée (ex: "Ecole", "Paiement", "Eleve", "Note")
        /// </summary>
        [Required]
        [MaxLength(50)]
