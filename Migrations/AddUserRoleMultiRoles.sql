...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251103133630_MakeStatutNullable') THEN
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251103133630_MakeStatutNullable', '6.0.25');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251103202028_MakeNiveauNullableInRole') THEN
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251103202028_MakeNiveauNullableInRole', '6.0.25');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251103202416_UpdateRoleNiveauToNullable') THEN

    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251103202416_UpdateRoleNiveauToNullable', '6.0.25');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251115125139_AddUserRoleMultiRoles') THEN

    ALTER TABLE `Utilisateurs` MODIFY COLUMN `ReferenceUtilisateur` char(36) COLLATE ascii_general_ci NULL;
...
BEGIN
    ...
    ALTER TABLE `Presences` MODIFY COLUMN `Longitute` longtext CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Presences` MODIFY COLUMN `Latitude` longtext CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Presences` MODIFY COLUMN `IdVacation` int NULL;
...
BEGIN
    ...
    ALTER TABLE `Paiements` MODIFY COLUMN `StatutPaiement` longtext CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Paiements` MODIFY COLUMN `ReferenceTransaction` longtext CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Paiements` MODIFY COLUMN `JustificatifUrl` longtext CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Paiements` MODIFY COLUMN `Commentaire` longtext CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Notifications` ADD `CanalUtilise` varchar(20) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Notifications` ADD `IdCampaign` int NULL;
...
BEGIN
    ...
    ALTER TABLE `Notifications` ADD `PayloadJson` longtext CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Notifications` ADD `Priorite` varchar(20) CHARACTER SET utf8mb4 NOT NULL DEFAULT '';
...
BEGIN
    ...
    ALTER TABLE `Notifications` ADD `StatutEnvoi` varchar(20) CHARACTER SET utf8mb4 NOT NULL DEFAULT '';
...
BEGIN
    ...
    ALTER TABLE `Notifications` ADD `TrackingId` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Eleves` MODIFY COLUMN `ReferenceEleve` char(36) COLLATE ascii_general_ci NULL;
...
BEGIN
    ...
    ALTER TABLE `Agents` MODIFY COLUMN `Prenom` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Agents` MODIFY COLUMN `Postnom` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Agents` MODIFY COLUMN `Nom` varchar(100) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Agents` MODIFY COLUMN `Genre` varchar(10) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Agents` MODIFY COLUMN `EtatCivil` varchar(20) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    CREATE TABLE `CommunicationCampaigns` (
        ...
        `Titre` varchar(200) CHARACTER SET utf8mb4 NOT NULL,
        `ContenuMarkdown` longtext CHARACTER SET utf8mb4 NOT NULL,
        `Statut` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
        `Importance` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
        `ChannelsJson` longtext CHARACTER SET utf8mb4 NOT NULL,
        `DateCreation` datetime(6) NOT NULL,
        `PlanifiedAt` datetime(6) NULL,
        `ExpirationAt` datetime(6) NULL,
        `RappelAuto` tinyint(1) NOT NULL,
        `ValidationAt` datetime(6) NULL,
        `ValidatedBy` int NULL,
        CONSTRAINT `PK_CommunicationCampaigns` PRIMARY KEY (`IdCampaign`),
        CONSTRAINT `FK_CommunicationCampaigns_Ecoles_IdEcole` FOREIGN KEY (`IdEcole`) REFERENCES `Ecoles` (`IdEcole`) ON DELETE CASCADE,
        CONSTRAINT `FK_CommunicationCampaigns_Utilisateurs_IdAuteur` FOREIGN KEY (`IdAuteur`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE CASCADE,
        CONSTRAINT `FK_CommunicationCampaigns_Utilisateurs_ValidatedBy` FOREIGN KEY (`ValidatedBy`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE SET NULL
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE TABLE `CommunicationTemplates` (
        ...
        `IdEcole` int NULL,
        `Nom` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
        `Langue` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
        `Titre` varchar(200) CHARACTER SET utf8mb4 NOT NULL,
        `ContenuMarkdown` longtext CHARACTER SET utf8mb4 NOT NULL,
        `PlaceholdersAutorises` longtext CHARACTER SET utf8mb4 NULL,
        `Version` int NOT NULL,
        `IsActif` tinyint(1) NOT NULL,
        `CreatedBy` int NOT NULL,
        `UpdatedBy` int NULL,
        `DateCreation` datetime(6) NOT NULL,
        `DateMaj` datetime(6) NULL,
        CONSTRAINT `PK_CommunicationTemplates` PRIMARY KEY (`IdTemplate`),
        CONSTRAINT `FK_CommunicationTemplates_Ecoles_IdEcole` FOREIGN KEY (`IdEcole`) REFERENCES `Ecoles` (`IdEcole`) ON DELETE SET NULL,
        CONSTRAINT `FK_CommunicationTemplates_Utilisateurs_CreatedBy` FOREIGN KEY (`CreatedBy`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE CASCADE,
        CONSTRAINT `FK_CommunicationTemplates_Utilisateurs_UpdatedBy` FOREIGN KEY (`UpdatedBy`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE SET NULL
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE TABLE `ParentCommunicationPreferences` (
        `IdPreference` int NOT NULL AUTO_INCREMENT,
        `IdTuteur` int NOT NULL,
        `Canal` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
        `OptIn` tinyint(1) NOT NULL,
        `DateAcceptation` datetime(6) NULL,
        `DateRefus` datetime(6) NULL,
        `Source` varchar(50) CHARACTER SET utf8mb4 NULL,
        CONSTRAINT `PK_ParentCommunicationPreferences` PRIMARY KEY (`IdPreference`),
        CONSTRAINT `FK_ParentCommunicationPreferences_Tuteurs_IdTuteur` FOREIGN KEY (`IdTuteur`) REFERENCES `Tuteurs` (`IdTuteur`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE TABLE `CampaignRecipients` (
        `IdRecipient` bigint NOT NULL AUTO_INCREMENT,
        `IdCampaign` int NOT NULL,
        `IdUtilisateur` int NOT NULL,
        `IdTuteur` int NULL,
        `IdEleve` int NULL,
        `IdNotification` int NULL,
        `PreferredChannel` varchar(20) CHARACTER SET utf8mb4 NULL,
        `FinalChannel` varchar(20) CHARACTER SET utf8mb4 NULL,
        `Status` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
        `DatePlanifie` datetime(6) NOT NULL,
        `DateEnvoi` datetime(6) NULL,
        `ErrorMessage` varchar(500) CHARACTER SET utf8mb4 NULL,
        CONSTRAINT `PK_CampaignRecipients` PRIMARY KEY (`IdRecipient`),
        CONSTRAINT `FK_CampaignRecipients_CommunicationCampaigns_IdCampaign` FOREIGN KEY (`IdCampaign`) REFERENCES `CommunicationCampaigns` (`IdCampaign`) ON DELETE CASCADE,
        CONSTRAINT `FK_CampaignRecipients_Eleves_IdEleve` FOREIGN KEY (`IdEleve`) REFERENCES `Eleves` (`IdEleve`) ON DELETE SET NULL,
        CONSTRAINT `FK_CampaignRecipients_Notifications_IdNotification` FOREIGN KEY (`IdNotification`) REFERENCES `Notifications` (`IdNotification`) ON DELETE SET NULL,
        CONSTRAINT `FK_CampaignRecipients_Tuteurs_IdTuteur` FOREIGN KEY (`IdTuteur`) REFERENCES `Tuteurs` (`IdTuteur`) ON DELETE SET NULL,
        CONSTRAINT `FK_CampaignRecipients_Utilisateurs_IdUtilisateur` FOREIGN KEY (`IdUtilisateur`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE TABLE `CommunicationHistory` (
        ...
        `DateAction` datetime(6) NOT NULL,
        `AdresseIP` varchar(45) CHARACTER SET utf8mb4 NULL,
        CONSTRAINT `PK_CommunicationHistory` PRIMARY KEY (`IdHistory`),
        CONSTRAINT `FK_CommunicationHistory_CommunicationCampaigns_IdCampaign` FOREIGN KEY (`IdCampaign`) REFERENCES `CommunicationCampaigns` (`IdCampaign`) ON DELETE CASCADE,
        CONSTRAINT `FK_CommunicationHistory_Utilisateurs_UserId` FOREIGN KEY (`UserId`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE SET NULL
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE TABLE `CommunicationSegments` (
        `IdSegment` int NOT NULL AUTO_INCREMENT,
        `IdCampaign` int NULL,
        `IdEcole` int NULL,
        `NomSegment` varchar(150) CHARACTER SET utf8mb4 NOT NULL,
        `TypeSegment` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
        `CriteriaJson` longtext CHARACTER SET utf8mb4 NOT NULL,
        `IsReusable` tinyint(1) NOT NULL,
        `CreatedBy` int NOT NULL,
        `DateCreation` datetime(6) NOT NULL,
        CONSTRAINT `PK_CommunicationSegments` PRIMARY KEY (`IdSegment`),
        CONSTRAINT `FK_CommunicationSegments_CommunicationCampaigns_IdCampaign` FOREIGN KEY (`IdCampaign`) REFERENCES `CommunicationCampaigns` (`IdCampaign`) ON DELETE CASCADE,
        CONSTRAINT `FK_CommunicationSegments_Ecoles_IdEcole` FOREIGN KEY (`IdEcole`) REFERENCES `Ecoles` (`IdEcole`) ON DELETE SET NULL,
        CONSTRAINT `FK_CommunicationSegments_Utilisateurs_CreatedBy` FOREIGN KEY (`CreatedBy`) REFERENCES `Utilisateurs` (`IdUtilisateur`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE INDEX `IX_Notifications_IdCampaign` ON `Notifications` (`IdCampaign`);
...
BEGIN
    ...
    CREATE INDEX `IX_CampaignRecipients_IdCampaign` ON `CampaignRecipients` (`IdCampaign`);
...
BEGIN
    ...
    CREATE INDEX `IX_CampaignRecipients_IdEleve` ON `CampaignRecipients` (`IdEleve`);
...
BEGIN
    ...
    CREATE INDEX `IX_CampaignRecipients_IdNotification` ON `CampaignRecipients` (`IdNotification`);
...
BEGIN
    ...
    CREATE INDEX `IX_CampaignRecipients_IdTuteur` ON `CampaignRecipients` (`IdTuteur`);
...
BEGIN
    ...
    CREATE INDEX `IX_CampaignRecipients_IdUtilisateur` ON `CampaignRecipients` (`IdUtilisateur`);
...
BEGIN
    ...
    CREATE INDEX `IX_CampaignRecipients_Status` ON `CampaignRecipients` (`Status`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationCampaigns_IdAuteur` ON `CommunicationCampaigns` (`IdAuteur`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationCampaigns_IdEcole_Statut` ON `CommunicationCampaigns` (`IdEcole`, `Statut`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationCampaigns_ValidatedBy` ON `CommunicationCampaigns` (`ValidatedBy`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationHistory_IdCampaign_Action` ON `CommunicationHistory` (`IdCampaign`, `Action`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationHistory_UserId` ON `CommunicationHistory` (`UserId`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationSegments_CreatedBy` ON `CommunicationSegments` (`CreatedBy`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationSegments_IdCampaign` ON `CommunicationSegments` (`IdCampaign`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationSegments_IdEcole` ON `CommunicationSegments` (`IdEcole`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationTemplates_CreatedBy` ON `CommunicationTemplates` (`CreatedBy`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationTemplates_IdEcole_IsActif` ON `CommunicationTemplates` (`IdEcole`, `IsActif`);
...
BEGIN
    ...
    CREATE INDEX `IX_CommunicationTemplates_UpdatedBy` ON `CommunicationTemplates` (`UpdatedBy`);
...
BEGIN
    ...
    CREATE UNIQUE INDEX `IX_ParentCommunicationPreferences_IdTuteur_Canal` ON `ParentCommunicationPreferences` (`IdTuteur`, `Canal`);
...
BEGIN
    ...
    ALTER TABLE `Notifications` ADD CONSTRAINT `FK_Notifications_CommunicationCampaigns_IdCampaign` FOREIGN KEY (`IdCampaign`) REFERENCES `CommunicationCampaigns` (`IdCampaign`);
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251115125139_AddUserRoleMultiRoles', '6.0.25');
