...
{
    /// <summary>
    /// Frais : IdEcole + Portee XOR (FraisDirections / FraisClasses). Drop IdDirection / IdClasse scalaires.
    /// </summary>
    public partial class FraisPorteeDirectionsClasses : Migration
    {
