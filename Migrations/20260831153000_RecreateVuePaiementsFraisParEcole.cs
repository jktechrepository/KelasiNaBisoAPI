...
{
    /// <summary>
    /// Resynchronise VuePaiementsFraisParEcole avec VuePaiementsFraisParEcoleDTO
    /// (NomCompletFormate, ReferenceTransaction, etc.).
    /// </summary>
    public partial class RecreateVuePaiementsFraisParEcole : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"DROP VIEW IF EXISTS `VuePaiementsFraisParEcole`;");
            migrationBuilder.Sql(GetCreateViewSql());
        }
        ...
        internal static string GetCreateViewSql() => @"
