...
namespace KelasiNaBiso.Services
{
    public class VuePaiementsFraisParEcoleService : IVuePaiementsFraisParEcoleRepository
    {
            ...
            int? idAnneeScolaire = null)
        {
            ...
            if (!idEcole.HasValue || idEcole.Value <= 0)
            {
                throw new InvalidOperationException(
                    $"Impossible de déterminer l'école pour l'élève {idEleve} afin de résoudre l'année scolaire.");
            }
            ...
            int? idAnneeScolaire = null)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"Impossible de d�terminer l'�cole pour le matricule '{matricule}' afin de r�soudre l'ann�e scolaire.");
            }
