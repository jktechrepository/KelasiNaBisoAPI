namespace KelasiNaBisoAPI.Services.Repositories
{
    ...
    public interface IEmailService
    {
        ...
        /// </summary>
        Task<bool> SendWelcomeEmailAsync(string email, string nomComplet, string defaultUsername, string telephone, string motDePasseParDefaut, string role, string nomEcole, string genre = "Masculin", string fonction = null, string matricule = null, string nomEnfant = null, string classeEnfant = null, string matriculeEnfant = null);
        ...
        /// </summary>
        Task<bool> SendGenericEmailAsync(
            string toEmail,
            string toName,
            string subject,
