...
{
    public class DashboardCaissierService : IDashboardCaissierService
    {
        ...
        public DashboardCaissierService(
        ...
        public Task<DashboardCaissierDto> GetDashboardCaissierAsync(
            int idEcole,
            int idUtilisateur,
        ...
        public async Task<DashboardCaissierClotureDto> GetClotureCaissierAsync(
            int idEcole,
            int idUtilisateur,
            int? idAnneeScolaire = null,
            DateTime? date = null,
            ...
            bool allowEcoleScope = false)
        {
            ...
            return new DashboardCaissierClotureDto
            {
        ...
        private async Task<DashboardCaissierDto> BuildDashboardAsync(
            int idEcole,
            int idUtilisateur,
            int? idAnneeScolaire,
            DateTime? date,
            ...
            bool allowEcoleScope)
        {
            ...
            return new DashboardCaissierDto
            {
                ...
                Resume = new ResumeCaissierJourDto
                {
                    NombrePaiements = paiements.Count,
                    MontantTotal = paiements.Sum(p => p.Montant),
                    PayInsReussis = payInsReussis,
                    PayInsEnAttente = payInsEnAttente,
                    PayInsEchoues = payInsEchoues
                },
