...
namespace KelasiNaBiso.Services
{
    ...
    public class AuditService : IAuditService
    {
        ...
        public AuditService(KelasiNaBisoDbContext context, ILogger<AuditService> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public async Task<List<AuditLog>> GetSchoolActivitiesAsync(
            ...
            int pageSize = 50)
        {
            var query = _context.AuditLogs.Where(a => a.IdEcole == idEcole);
            ...
            int? idEcole = null)
        {
            ...
            if (idEcole.HasValue)
                query = query.Where(a => a.IdEcole == idEcole.Value);
